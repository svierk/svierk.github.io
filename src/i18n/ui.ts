...
export const ui = {
  en: {
    ...
    'speaking.mapLabel': 'World map with the cities I have spoken in',
    'speaking.mapHint': 'Select a marker to filter the events by city.',
  ...
  de: {
    ...
    'speaking.comingSoon': 'Coming soon…',
    'speaking.mapLabel': 'Weltkarte mit den Städten, in denen ich gesprochen habe',
    'speaking.mapHint': 'Marker auswählen, um die Events nach Stadt zu filtern.',
    'speaking.statEvents': 'Events',
